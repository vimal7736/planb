    ...
    <section id="hero" className="relative h-screen bg-background overflow-hidden flex items-center pt-14">
      <div className="w-full h-full relative">
        ...
        <div className="w-full h-full px-4 md:px-12 xl:px-24 flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
          ...
          <div className="flex-1 w-full relative min-h-[400px] flex flex-col justify-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <Link 
                  href="#booking" 
                  className="px-8 py-4 bg-background text-foreground border-2 border-primary/20 rounded-full font-bold transition-transform transform hover:scale-105 active:scale-95 shadow-lg text-center"
                >
                  Book Appointment
                </Link>
                <Link 
                  href="#portfolio" 
                  className="px-8 py-4 bg-primary text-background rounded-full font-bold transition-transform transform hover:scale-105 active:scale-95 shadow-lg text-center"
                >
                  Explore Portfolio
                </Link>
              </div>
          ...
          {/* Right Column - Image Carousel (Stays Static) */}
          <div className="flex-1 w-full h-full relative py-10 md:py-16 flex items-center">
            <div className="w-full relative aspect-[4/5] md:aspect-square rounded-[3rem] overflow-hidden shadow-2xl border-4 border-background-alt group">
