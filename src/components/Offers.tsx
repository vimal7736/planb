      ...
      <div className="w-full px-4 md:px-12 xl:px-24">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-background/90 text-sm md:text-base text-center md:text-left font-medium">
            Book any minimalist floral design this month and receive <span className="font-bold underline decoration-2 underline-offset-2">20% off</span> your session.
          </p>
          
          <button 
            onClick={handleBookingClick}
            className="px-6 py-2 bg-background text-primary text-sm font-bold uppercase tracking-wider rounded-full hover:scale-95 transition-transform shadow-lg"
          >
            Claim Offer
          </button>
        </div>
