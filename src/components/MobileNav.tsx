...
export default function MobileNav() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 md:hidden w-[95%] max-w-[450px] flex items-center gap-3">
      <div className="mobile-nav-wrap w-full justify-between flex-1">
        <input
          type="radio"
          id="rd-1"
          name="mobile-nav"
      ...
      <div className="theme-switch shrink-0 bg-background-alt rounded-full shadow-[0_10px_25px_-5px_rgba(0,0,0,0.15)] border border-accent-secondary" style={{ fontSize: '1.2rem', padding: '4px' }}>
        <input 
          type="checkbox" 
          ...
          style={{ display: 'none' }}
        />
        <label htmlFor="mobile-theme-checkbox" style={{ margin: 0 }}>
          <div></div>
          <span>
