    ...
    <section id="booking" className="py-16 md:py-24 relative overflow-hidden">
      ...
      {isSuccessOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          <div className="relative bg-background-alt border border-primary/20 p-8 md:p-12 rounded-3xl shadow-[0_0_100px_rgba(85,107,47,0.2)] max-w-lg w-full text-center animate-in zoom-in-95 fade-in duration-300">
            {/* Close Button */}
            <button 
            ...
            <h3 className="text-3xl font-serif font-black mb-4">Request Sent!</h3>
            ...
            <div className="bg-primary/5 border border-primary/10 rounded-2xl p-6 mb-8">
              <p className="text-sm font-medium tracking-widest uppercase opacity-60 mb-2">Want faster response?</p>
              <p className="text-lg font-serif font-bold mb-4">Message Sanjay Munna directly:</p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 px-6 py-3 bg-[#25D366] text-white rounded-xl font-bold hover:scale-105 transition-transform shadow-lg shadow-[#25D366]/20"
                >
                ...
                <a 
                  ...
                  className="flex items-center justify-center gap-2 px-6 py-3 bg-background border border-primary/20 rounded-xl font-bold hover:bg-primary/5 transition-colors"
                >
            ...
            <button 
              onClick={() => setIsSuccessOpen(false)}
              className="text-sm font-medium opacity-60 hover:opacity-100 uppercase tracking-widest transition-opacity"
            >
              Close
            </button>
          </div>
