...
const REVIEWS = [
  ...
  },
  {
    name: "Marcus T.",
    date: "3 weeks ago",
    text: "I came in for a cover-up and didn't think it was possible to hide my old tattoo so cleanly. The black and grey is out of this world.",
    rating: 5,
  },
  {
    name: "Elena V.",
    date: "1 month ago",
    text: "My first tattoo experience couldn't have been better. They took the time to explain the entire process. The micro-realism is mind-blowing.",
    rating: 5,
  },
  {
    name: "David K.",
    date: "4 months ago",
    text: "Best studio in the city. The vibe is immaculate, very private, and the artists actually listen to your ideas.",
    rating: 5,
  },
  {
    name: "Sarah L.",
    date: "1 week ago",
    text: "So happy with my custom piece! The attention to detail is incredible and the studio felt so safe and welcoming.",
    rating: 5,
  }
];
    ...
    <div className="z-[1] w-full h-full rounded-[10px] border border-primary/20 bg-background bg-[radial-gradient(circle_280px_at_0%_0%,_var(--accent-secondary)_0%,_transparent_100%)] relative flex flex-col items-center justify-center p-4 md:p-6 text-foreground overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-between h-full w-full py-1 md:py-2 px-1">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <div>
            <p className="font-bold text-xs md:text-sm tracking-wide">{review.name}</p>
            <p className="text-[10px] md:text-xs opacity-50">{review.date}</p>
          </div>
        </div>
      </div>
